...
<body>
    <nav>
    <h1>ADMIN PANEL</h1>
    <div class="menu"><li><a href="admin.php" class="active"style="color:white;" >users</a></li>
    <li><a href="coursedetails.php" style="color:red;">course details</a></li></div>
    </nav>
            ...
            if(mysqli_num_rows($fire)>0)
            {
                ...
                { ?>
                    ...
                    <td style="text-align:center;"> <?php echo $result['course']; ?> </td>
                      ...
                      <td  style="text-align:center;"><a href="admindelete.php?delete_id=<?php echo $result['course']; ?>& id2=<?php echo $result['name']?>" onclick="return confirm('sure to delete !'); " ><i class="fa fa-trash" style="font-size:20px;color:red;"></i></a>
 </td>
                    </tr> 
                    <?php 
                }  
